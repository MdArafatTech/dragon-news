...
import nationalImg from '../assets/argentina.jpeg'; // Replace with your actual image path
...
const NationalNews = () => {
  return (
    <div className="p-[5%] max-w-5xl mx-auto">
      ...
      <a href="https://www.newsnow.co.uk/h/World+News/Latin+America/South+America/Argentina/Sport" className="text-blue-600 text-lg font-semibold hover:underline">
