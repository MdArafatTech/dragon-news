...
import nationalImg from '../assets/international.jpg'; // Replace with your actual image path
...
const NationalNews = () => {
  return (
    <div className="p-[5%] max-w-5xl mx-auto">
      ...
      <a href="https://www.bbc.com/news" className="text-blue-600 text-lg font-semibold hover:underline">
