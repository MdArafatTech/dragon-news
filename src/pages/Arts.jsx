...
import nationalImg from '../assets/arts.jpg'; // Replace with your actual image path
...
const NationalNews = () => {
  return (
    <div className="p-[5%] max-w-5xl mx-auto">
      ...
      <a href="https://en.wikipedia.org/wiki/The_arts" className="text-blue-600 text-lg font-semibold hover:underline">
