...
import nationalImg from '../assets/bachelor.jpg'; // Replace with your actual image path
...
const NationalNews = () => {
  return (
    <div className="p-[5%] max-w-5xl mx-auto">
      ...
      <a href="https://youtu.be/PTSkFu8Msys?si=bDLx82e2PJWeQ3QG" className="text-blue-600 text-lg font-semibold hover:underline">
